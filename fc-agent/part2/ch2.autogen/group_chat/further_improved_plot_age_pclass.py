# filename: further_improved_plot_age_pclass.py
import pandas as pd
...
sns.boxplot(x='pclass', y='age', hue='pclass', data=data, palette='pastel', dodge=True)
...
# 차트를 파일로 저장
plt.savefig('age_pclass_relation_final.png')
plt.close()